...
| `references/testing.md` | 三层测试分类（Universal Hard Invariant / Capability Hard Tests / Quality Metrics）、23 个能力场景、能力 → 场景映射、Root Cause 判定（CASE A–F）、验收指标、Quality Metrics（write / retrieval / context / hygiene / end-task delta / cost） |
